...
public class ExamSystem extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        for (int i = 0, y = 1; i < x; i++, y++) //loop will go till number of bookmarks and will see if selected bookmark is equal to bookmark(y) 
        {
    ...
    void set() {
        ...
        if (current == 4) {
            l.setText("Que5: Which of the following is NOT OOPS concept in Java?");
            jb[0].setText("Inheritance");
            jb[1].setText("Encapsulation");
            jb[2].setText("Compilation");
            jb[3].setText("Polymorphism");
        }
        if (current == 5) {
        ...
        if (current == 8) {
            l.setText("Que9: Which concept of Java is achieved by combining methods and attribute into a class?");
